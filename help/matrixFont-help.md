# matrixFont v1.2 // Руководство пользователя
...
2. Откройте свой файл `*.uk.po` в [Poedit](https://poedit.net/download) или [Virtaal](http://translate.sourceforge.net/wiki/virtaal/index).
