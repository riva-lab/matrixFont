...
1. Добавлен импорт из изображения карты символов, сгенерированного matrixFont.
...
1. Добавлена опция "Значений в строке [4-128]" в генератор кода.
...
5. Значки неактивных кнопок сделаны менее яркими.

---

### `v2.2.8.96` `2025.04.17`

1. Переменная проекта шрифта mxFont сделана глобальной (упрощение логики).
2. Исправлена ошибка отрисовки карты символов с кодом начального символа некратным количеству столбцов таблицы.
3. Исправлена та же ошибка при экспорте карты в изображение.
4. Новый дизайн окна "Задать диапазон".

---

### `v2.2.9.97` `2025.08.25`

1. В окне карты символов список параметра "Столбцы" дополнен значениями 128 и 256.
...
### `v2.3.0.98` `2025.09.01`

1. Исправлена ошибка в экспорте RBF.
2. Добавлена поддержка экспорта в Adobe BDF.

---

### `v2.3.1.99` `2025.09.02`

1. Добавлена поддержка импорта Adobe BDF.

---

### `v2.3.2.100` `2025.09.04`

1. Окно и команды "Оптимизация" удалены, функционал перенесен в окно "Изменить размер".
2. Исправлены обнаруженные ошибки.
3. Обновлены readme и справка.
...
- [x] добавить поддержку формата Adobe BDF
