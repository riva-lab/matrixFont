...
| Релиз             | 2017.07.04 - [v0.0.0.39](#`v0.0.0.39`-—-тестовый релиз) (предварительный) |
|                   | 2021.08.27 - [v1.1.0.52](#`v1.1.0.52`----`2021.08.27`) (первый публичный) |
|                   | 2023.08.15 - [v1.2.0.55](#`v1.2.0.55`----`2023.08.15`)       |
...
1.  Протестировано на поддержку разных DPI системы.
1.  Небольшой рефакторинг окна about.
1.  Обновлены скрипты создания релизных архивов.
